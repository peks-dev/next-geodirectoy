        ...
        {stepLabels.map((label, index) => (
          <li key={index}>
            <button
              ...
              className={`w-[clamp(1.8rem,3vw,3rem)] h-[clamp(1.8rem,3vw,3rem)] border-(length:--border-xs) border-foreground shadow-[inset_0_2px_4px_#fefefe80] transition-colors duration-100 hover:bg-foreground/10  ${
