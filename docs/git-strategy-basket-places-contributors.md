...
# Git Strategy - Basket Places Contributors   
 ...
 ### 📦 Technical Scopes (Architecture Layers)
 - ui - Reusable/global UI components
 - api - API endpoints and logic
 - db - Migrations, database schemas
 - auth - Everything related to authentication
 - config - Configurations (Vercel, Supabase, etc.)
 ### 🏀 Functional Scopes (Business Features)
 - communities - Everything about communities (search, listing, details)
 - contribution - System for adding communities
